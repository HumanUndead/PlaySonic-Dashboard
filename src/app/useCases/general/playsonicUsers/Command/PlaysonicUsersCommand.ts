...
import { IPlaysonicUserUpdate } from "@domain/entities/general/PlaysonicUsers/PlaysonicUsers";
...
export class PlaysonicUsersCommand implements ICommand {
  constructor(private readonly httpPostClient: IHttpClient) {}

  async updatePlaysonicUser(
    url: any,
    body: IPlaysonicUserUpdate
  ): Promise<any> {
...
export const PlaysonicUsersCommandInstance = new PlaysonicUsersCommand(
  makeAxiosHttpClient()
);
